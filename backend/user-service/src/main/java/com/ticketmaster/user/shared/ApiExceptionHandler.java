...
import com.ticketmaster.user.paymentmethods.PaymentMethodNotFoundException;
...
public class ApiExceptionHandler {
    ...
    /**
     * 404, not 403 — see PaymentMethodNotFoundException's javadoc for why
     * "not yours" and "doesn't exist" must answer identically. Confirming
     * a payment method id exists (even someone else's, even as a 403)
     * hands a caller probing sequential/guessable ids a free existence
     * oracle; a uniform 404 does not.
     */
    @ExceptionHandler(PaymentMethodNotFoundException.class)
    public ProblemDetail handlePaymentMethodNotFound(PaymentMethodNotFoundException e) {
